...
import imageio, glob, numpy, scipy
...
p.add_argument("-v", "--video_mode", help="set to true to sort video", default="true")
...
class PixelSort:
    def __init__(self, arguments):
        ...
        self.output_image_path = "E:\Scripts\pixel sort\images\output"
        ...
        self.vid_mode = arguments.video_mode
    ...
    def recursive_gif(self, duration, length):
        i = 1
        self.begin_sort(self.output_image_path + "5.png", self.image_input_path)
        while i < length:
            self.begin_sort(self.output_image_path + str(100 + i) + ".png", self.output_image_path + str(i-1) + ".png")
            #modify animations here
            self.bottom_threshold -= 0.017
...
pxs.recursive_gif(22, __args.animation)
